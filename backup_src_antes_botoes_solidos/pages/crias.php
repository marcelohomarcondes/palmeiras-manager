...
echo '<button class="btn btnbtn-primary btn-primary">Salvar</button>';
if ($edit) echo '<a class="btnbtn-outline-secondary" href="/?page=crias">Cancelar</a>';
echo '</form>';
...
foreach ($rows as $r) {
  ...
  echo '<button type="button" class="btn btn-sm js-promote btn-outline-success"
              data-id="' . $rid . '"
              data-name="' . h($rname) . '">
          Promover
        </button> ';

  echo '<a class="btn btn-sm btn-outline-danger" href="/?page=crias&dismiss=' . $rid . '" onclick="return confirm(\'Dispensar este atleta da base? Ele irá para a lista de dispensados.\')">Dispensar</a>';
...
echo '        </div>
          ...
          <button class="btn btnbtn-primary btn-primary">Salvar</button>
        </form>
      </div>
    </div>
  </div>
