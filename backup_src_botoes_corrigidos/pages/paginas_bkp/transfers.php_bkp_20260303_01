...
/**
 * Exibição da tabela: dd/mm/aaaa
 * (mantém o armazenamento/filtros em YYYY-MM-DD)
 */
function fmt_date_br(?string $iso): string {
  ...
  // fallback: tenta pegar os 10 primeiros chars e converter
 ...
 *
 * Como a tabela `players` não possui coluna "club"/"team", usamos a regra prática:
...
// ordem estável (id DESC como segundo critério)
...
echo '<a class="btn btn-sm btn-outline-secondary" href="' . h(build_qs([
  'f_date_from'=>null,'f_date_to'=>null,'f_season'=>null,'f_type'=>null,'f_athlete'=>null,'f_origin'=>null,'f_dest'=>null,'f_value_min'=>null,'f_value_max'=>null,
  'sort'=>null,'dir'=>null,'edit'=>null
])) . '">Limpar filtros</a>';
echo '</div>';
...
if (!$rows) {
  ...
  echo '<form method="get" class="mb-2">';
  ...
  echo '<input class="form-control form-control-sm" type="date" name="f_date_from" value="' . h($f['date_from']) . '" title="Data (de)" placeholder="de">';
  echo '<input class="form-control form-control-sm" type="date" name="f_date_to" value="' . h($f['date_to']) . '" title="Data (até)" placeholder="até">';
  echo '</div>';
  echo '</th>';

  echo '<th>';
  echo '<select class="form-select form-select-sm" name="f_season">';
  ...
  echo '<th>';
  echo '<select class="form-select form-select-sm" name="f_type">';
  ...
  echo '<th><input class="form-control form-control-sm" name="f_athlete" value="' . h($f['athlete']) . '" placeholder="filtrar..."></th>';
  echo '<th><input class="form-control form-control-sm" name="f_origin" value="' . h($f['origin']) . '" placeholder="filtrar..."></th>';
  echo '<th><input class="form-control form-control-sm" name="f_dest" value="' . h($f['dest']) . '" placeholder="filtrar..."></th>';

  echo '<th class="text-end">';
  echo '<div class="d-flex gap-1 justify-content-end">';
  echo '<input class="form-control form-control-sm text-end" name="f_value_min" value="' . h($f['value_min']) . '" placeholder="mín">';
  echo '<input class="form-control form-control-sm text-end" name="f_value_max" value="' . h($f['value_max']) . '" placeholder="máx">';
  echo '</div>';
  echo '</th>';

  echo '<th class="text-end">';
  echo '<button class="btn btn-sm btn-outline-primary" type="submit">Filtrar</button>';
  echo '</th>';
  echo '</tr>';
  ...
  foreach ($rows as $r) {
    ...
    echo '<a class="btn btn-sm btn-outline-primary" href="' . h(build_qs(['edit' => $rid])) . '">Editar</a>';
    echo '</td>';
    echo '</tr>';
  }
