 ...
 * - players: colunas existentes (confirmadas): id, user_id, name, shirt_number, primary_position,
 *   secondary_positions, is_active, club_name, updated_at, created_at
 * - transfers: esperado conter ao menos:
 *   id, user_id, season, type, athlete_name, club_origin, club_destination, value, term, grade,
 *   extra_player_name, shirt_number_assigned, transaction_date, notes, player_id
 */
 ...
 * - Templates e create_match já filtram is_active=1
 */
 ...
 * - somente do seu clube
 * - mantém ativos e inativos (para editar histórico antigo)
 */
$players = q(
  $pdo,
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  // validação mínima
  if ($season === '' || $type === '' || $athleteName === '' || $date === '') {
