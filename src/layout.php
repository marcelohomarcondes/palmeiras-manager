...
/* Outline mantidos por compatibilidade, mas com comportamento consistente */
.btn-outline-primary{
...
/* Força anchors, buttons e inputs a seguirem o mesmo padrão sólido */
a.btn,
button.btn,
input.btn,
.btn{
...
/* Ações customizadas sempre sólidas */
.btn-edit,
.table .btn-primary,
...
.pm-table-wrap .btn-primary:hover{
  background:var(--primary-hover) !important;
  border-color:var(--primary-hover) !important;
  color:#ffffff !important;
}
...
.pm-table-wrap .btn-success:hover{
  background:var(--success-hover) !important;
  border-color:var(--success-hover) !important;
  color:#ffffff !important;
}
...
.pm-table-wrap .btn-warning:hover,
.table .btn-warning:focus,
.pm-table-wrap .btn-warning:focus,
.table .btn-warning:active,
.pm-table-wrap .btn-warning:active{
  background:var(--warning-hover) !important;
  border-color:var(--warning-hover) !important;
  color:#ffffff !important;
}
...
.pm-table-wrap .btn-secondary:hover{
  background:var(--secondary-hover) !important;
  border-color:var(--secondary-hover) !important;
  color:#ffffff !important;
}
