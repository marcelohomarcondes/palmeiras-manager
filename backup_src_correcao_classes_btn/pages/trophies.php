...
if ($edit) echo '<a class="btnbtn-outline-secondary" href="/?page=trophies">Cancelar</a>';
echo '</form></div></div>';
...
foreach ($competitions as $c) {
  ...
  echo '        <button type="button" class="btnbtn-outline-secondary" data-bs-dismiss="modal">Fechar</button>';
  echo '      </div>';
  echo '    </div>';
  echo '  </div>';
  echo '</div>';
